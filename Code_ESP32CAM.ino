...
// const char *password = "0388802393";
const char *ssid = "AndroidAP5065";
const char *password = "173173173";
const char *serverUrl = "http://192.168.43.181:8080/api/add-to-cart/product/";
/* ======================================== */
...
void sendData(const struct quirc_data *data) {
  HTTPClient http;

  QRCodeResult = (const char *)data->payload;
  if (QRCodeResult != "Decoding FAILED") {
    http.begin(serverUrl + QRCodeResult);
